...
ToastNotificationUtil* _gPToastNotificationUtilObject;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HRESULT hr = ToastNotificationUtil::TryCreateShortcut();
   if (!SUCCEEDED(hr)) {
	   return FALSE;
   }
   ...
   _gPToastNotificationUtilObject = new ToastNotificationUtil(hWnd, hEdit);
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
			case ID_AddToastNotification:
				_gPToastNotificationUtilObject->DisplayToast();
				break;
            default:
